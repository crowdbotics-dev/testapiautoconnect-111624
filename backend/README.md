...
## Project Structure
    ...
    ├── testapiautoconnect_111624  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_111624`
...
2. Clone this repo and `cd testapiautoconnect_111624`
